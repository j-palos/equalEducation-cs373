                            ...
                            <div className="row">
                                ...
                                <div className="col-md-6">
                                    ...
                                    <p className="lead text-center">Description:
                                        <strong>Oakland Unified School District is a public education school district that operates about 86 elementary schools (K-5),
                                    ...
                                    <div className="text-center">
                                        <a href="https://en.wikipedia.org/wiki/Oakland_Unified_School_District" className="btn btn-primary center">Source</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div className="col-md-6 d-flex align-items-stretch">
                                    <div className="card" style={{width: '18rem'}}>
                                        ...
                                        <div className="card-body text-center d-flex flex-column">
                                            ...
                                            <Link to="/charity/1" className="mt-auto btn btn-primary">More Details</Link>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-md-6 d-flex align-items-stretch">
                                    <div className="card" style={{width: '18rem'}}>
                                        ...
                                        <div className="card-body text-center d-flex flex-column">
                                            ...
                                            <ul className="list-unstyled mt-auto">
                                                <li className="card-text text-left">
                                                    We are seeking volunteering to help us on-board volunteer tutors into classrooms across Oakland and
                                                    provide excellent customer service to all of the teachers, parents, and education professionals that we
                                                    engage with.
                                                </li>
                                            </ul>
                                            <Link to="/volunteer/1" className="mt-auto btn btn-primary">View Event</Link>
                                        </div>
                                    </div>
                                </div>
                            </div>
