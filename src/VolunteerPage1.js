                    ...
                    <div>
                        <div className="container mt-5">
                            <div className="jumbotron">
                                <h1 className="display-4 text-center">Seeking Operations Volunteer for Public Education
                                    Fund</h1>
                            </div>
                            <div className="row">
                                ...
                                <div className="col-md-6">
                                    <p className="lead text-center">Place: <strong>520 3rd St. Suite #109 </strong></p>
                                    <p className="lead text-center"><strong>Oakland, CA 94607</strong></p><p/>
                                    ...
                                    <p className="lead text-center">Description:
                                        <strong>The Oakland Public Education Fund connects public schools with tools,
                                            funs, and volunteers so all students can thrive. In a large, urban school
                                            district like Oakland,
                                            recruiting additional resources for students is so important, and we invite
                                            you to join our work! We are seeking volunteering to help us on-board
                                            volunteer tutors into classrooms
                                            across Oakland and provide excellent customer service to all of the
                                            teachers, parents, and education professionals that we engage with.
                                        </strong>
                                    </p>
                                    <div className="text-center">
                                        <a href="https://www.volunteermatch.org/search/opp3015109.jsp"
                            ...
                            <div className="row">
                                <div className="col-md-6 d-flex align-items-stretch">
                                    <div className="card" style={{width: '18rem'}}>
                                        <img className="card-img-top" src={oaklandFund}
