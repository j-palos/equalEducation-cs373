                            ...
                            <div className="carousel-item active">
                                ...
                                <div className="container">
                                    <div className="carousel-caption text-left">
                                        ...
                                        <p><Link to={"/school"} className="btn btn-lg btn-primary"  role="button">Learn More</Link></p>
                                    </div>
                                </div>
                            </div>
                            <div className="carousel-item">
                                ...
                                <div className="container">
                                    <div className="carousel-caption">
                                        ...
                                        <p><Link className="btn btn-lg btn-primary" to="/volunteer" role="button">Learn More</Link></p>
                                    </div>
                                </div>
                            </div>
                            <div className="carousel-item">
                                ...
                                <div className="container">
                                    <div className="carousel-caption text-right">
                                        ...
                                        <p><Link className="btn btn-lg btn-primary" to="/charity" role="button">Learn More</Link></p>
                                    </div>
                                </div>
                            </div>
                        </div>
