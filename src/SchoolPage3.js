                            ...
                            <div className="row">
                                ...
                                <div className="col-md-6">
                                    ...
                                    <p className="lead text-center">Description:
                                        <strong>The Houston Independent School District is the largest school district in Texas and the seventh-largest in the United States.
                                            It serves approximately 215,000 students at 283 campuses and is one of the largest employers in Houston, with about 29,000 team members.
                                        </strong>
                                    </p>
                                    <div className="text-center">
                                        <a href="https://www.houstonisd.org/domain/7892" className="btn btn-primary center">Source</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div className="card-body text-center d-flex flex-column">
                                            ...
                                            <ul className="list-unstyled mt-auto">
                                                <li className="card-text text-left">
                                                    Pratham USA is a volunteer-driven organization with 16 chapters across the United States
                                                    that raise awareness and mobilize financial resources for our work on the ground.
                                                </li>
                                            </ul>
                                            <Link to="/charity/3" className="mt-auto btn btn-primary">More Details</Link>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-md-6 d-flex align-items-stretch">
                                    <div className="card" style={{width: '18rem'}}>
                                        ...
                                        <div className="card-body text-center d-flex flex-column">
                                            ...
                                            <ul className="list-unstyled mt-auto">
                                                <li className="card-text text-left">
                                                    Save the date for the 2018 Houston holiday luncheon. Proceeds from the event will support Pratham’s
                                                    vocational training program, which empowers young women through education and skills training.
                                                </li>
                                            </ul>
                                            <Link to="/volunteer/3" className="mt-auto btn btn-primary">View Event</Link>
                                        </div>
                                    </div>
                                </div>
                            </div>
