...
export const schoolFilterQuery = [
    'State', 'Population', 'Poverty'
];
export const schoolSortQuery = [
    'name', 'population'
];
export const communityFilterQuery = [
    'State', 'Population'
];
export const communitySortQuery = [
    'Name', 'Population'
];

export const charityFilterQuery = [
    'State', 'Scope', 'Category', 'Rating'
];
const nameSort = {value: 'Name', label: 'Name'};
const nameComSort = {value: 'community', label: 'Name'};
...
export const sortables =
    {
        community: [nameComSort, populationSort],
        school: [nameSort, povertySort, populationSort],
        charity: [nameSort, ratingSort]
    };
