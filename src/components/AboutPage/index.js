                ...
                <main role="main">
                    ...
                    <Col className="tools">
                        <ul className="caption-style-4" id="tools-group">
                            ...
                            <li>
                                <img src={require("../../images/logo/namecheap.png")} className="img-size"
                                     alt="namecheap"/>
                                <div className="caption">
                                    <div className="blur"></div>
                                    <div className="caption-text">
                            ...
                            <li>
                                <img src={require("../../images/logo/selenium.png")} className="img-size"
                                     alt="selenium"/>
                                <div className="caption">
                                    <div className="blur"></div>
                                    <div className="caption-text">
                            ...
                            <li>
                                <img src={require("../../images/logo/grammarly.jpeg")} className="img-size"
                                     alt="grammarly"/>
                                <div className="caption">
                                    <div className="blur"></div>
                                    <div className="caption-text">
