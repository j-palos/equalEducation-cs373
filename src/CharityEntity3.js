                        ...
                        <div className="container mt-5">
                            ...
                            <div className="row">
                                ...
                                <div className="col-md-6">
                                    <p className="lead text-center">Located at: <strong>9703 Richmond Avenue Suite 102</strong></p><p className="lead text-center"><strong>Houston, TX 77042</strong></p><p />
                                    ...
                                    <p className="lead text-center">Website URL: <a href="https://prathamusa.org" className="text-dark"><strong>prathamusa.org</strong></a></p>
                                    <p className="lead text-center">Mission Statement:
                                        <strong>Pratham USA is a 501(c)(3) nonprofit organization which supports Pratham Education Foundation in its mission of improving child literacy, providing vocational skills
                                            and supporting women to complete their education in India; and encourages volunteerism in the US.
                                        </strong>
                                    </p>
                                    <div className="text-center">
                                        <a href="https://www.charitynavigator.org/index.cfm?bay=search.summary&orgid=7676" className="btn btn-primary center">Source</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div className="col-md-6 d-flex align-items-stretch">
                                    <div className="card" style={{width: '18rem'}}>
                                        ...
                                        <div className="card-body text-center d-flex flex-column">
                                            ...
                                            <ul className="list-unstyled mt-auto">
                                                <li className="card-text text-left">
                                                    Save the date for the 2018 Houston holiday luncheon. Proceeds from the event will support Pratham’s vocational training program,
                                                    which empowers young women through education and skills training.
                                                </li>
                                            </ul>
                                            <Link to="/volunteer/3" className="mt-auto btn btn-primary">View Events</Link>
                                        </div>
                                    </div>
                                </div>
                            </div>
