...
class SchoolPage extends Component {
    ...
    render() {
        return (
                        ...
                        <div className="row">
                            <div className="col-md-4 text-center d-flex align-items-stretch">
                                <div className="card mb-4 box-shadow">
                                    <div className="distimg"><Link to="school/1"><img className="card-img-top" src={oakland} alt /></Link></div>
                                    <div className="card-body">
                                        <h2 className="card-text"><Link to="school/1" className="text-dark">Oakland Oakland Unified School District</Link></h2>
                                        <p className="card-text"><span>Location: <strong>Oakland, California</strong></span></p>
                                        <p className="card-text"><span>Population under Poverty: <strong>12,817</strong></span></p>
            ...
            middle schools (6-8), and high schools (9-12) and 32 district-authorized charter schools in Oakland, California, United States serving 49,000 students.</span></p>
                                        <p className="card-text"><span>Opportunities Available: <Link to="volunteer/1" className="text-dark"><strong>Seeking Operations Volunteer for Public Education Fund</strong></Link></span></p>
                            ...
                            <div className="col-md-4 text-center d-flex align-items-stretch">
                                <div className="card mb-4 box-shadow">
                                    <div className="distimg"><Link to="school/2"><img className="card-img-top" src={houston} alt /></Link></div>
                                    <div className="card-body">
                                        <h2 className="card-text"><Link to="school/2" className="text-dark">Texas City Independent School District</Link></h2>
                                        <p className="card-text"><span>Location: <strong>Texas City, Texas</strong></span></p>
                                        <p className="card-text"><span>Population under Poverty: <strong>1,594</strong></span></p>
                                        <p className="card-text"><span>Texas City ISD has 14 schools and nearly 9,000 students in 78.31 square miles of La Marque and Texas City. </span></p>
                                        <p className="card-text"><span>Opportunities Available: <Link to="volunteer/2" className="text-dark"><strong>Dream Builders Coordinator</strong></Link></span></p>
                            ...
                            <div className="col-md-4 text-center d-flex align-items-stretch">
                                <div className="card mb-4 box-shadow">
                                    <div className="distimg"><Link to="school/3"><img className="card-img-top" src={houstonisd} alt /></Link></div>
                                    <div className="card-body">
                                        <h2 className="card-text"><Link to="school/3" className="text-dark">Houston Independent School District</Link></h2>
                                        <p className="card-text"><span>Location: <strong>Houston, Texas</strong></span></p>
                                        <p className="card-text"><span>Population under Poverty: <strong>76,878</strong></span></p>
                                        <p className="card-text"><span>The Houston Independent School District is the largest school district in Texas and the seventh-largest in the United States.</span></p>
                                        <p className="card-text"><span>Opportunities Available: <Link to="volunteer/3" className="text-dark"><strong>Houston Holiday Luncheon 2018</strong></Link></span></p>
