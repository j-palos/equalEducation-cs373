...
class CharityPage1 extends Component {
                                ...
                                <div className="col-md-6 d-flex align-items-stretch">
                                    <div className="card" style={{width: '18rem'}}>
                                        ...
                                        <div className="card-body text-center d-flex flex-column">
                                            ...
                                            <a href="school1.html" className="mt-auto btn btn-primary">More Details</a>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-md-6 d-flex align-items-stretch">
                                    <div className="card" style={{width: '18rem'}}>
                                        ...
                                        <div className="card-body text-center d-flex flex-column">
                                            ...
                                            <a href="volunteer1.html" className="mt-auto btn btn-primary">View Events</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
